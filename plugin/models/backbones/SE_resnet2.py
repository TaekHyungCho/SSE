...
class SE_ResNet2(BaseModule):
    ...
    def __init__(self,
        ...
        super(SE_ResNet2,self).__init__(init_cfg)
        ...
        self.pure = pure
        self.basis = get_basis(dir=save_dir,filename=filename[0],permute=self.permute,pure=self.pure)
        self.basis_Z2_H = get_basis(dir=save_dir,filename=filename[1],permute=self.permute,pure=self.pure)
    ...
    def train(self,mode=True):
        super(SE_ResNet2,self).train(mode)
