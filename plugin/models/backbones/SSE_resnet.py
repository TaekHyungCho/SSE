...
from plugin.utils import SEPConv_Z2_H, SEPConv_H_H, SEConv_H_H_1x1, SEMaxProjection
from plugin.utils.basis import get_basis

class SEP_ResBlock(BaseModule):
    ...
    def __init__(self,in_channels,out_channels,basis,
        ...
        super(SEP_ResBlock,self).__init__(init_cfg)
        ...
        self.conv2 = nn.Sequential(
                        SEPConv_H_H(in_channels=out_channels,
...
class SEP_ResNet(BaseModule):

    arch_settings = {
        50: (SEP_ResBlock,(3, 4, 6, 3),4),
        101: (SEP_ResBlock,(3, 4, 23, 3),4)
    }
    ...
    def __init__(self,
        ...
        super(SEP_ResNet,self).__init__(init_cfg)
    ...
    def make_res_layer(self,in_channels,out_channels,res_repeat,stride,expansion,permute=True):
        ...
        for idx in range(1,res_repeat):
            model.add_module('SEP_res{}'.format(idx),
    ...
    def train(self,mode=True):
        super(SEP_ResNet,self).train(mode)
